...
class Course(models.Model):
    title = models.CharField(max_length=100, verbose_name='Название курса', help_text='Укажите курс', null=False)
    description = models.TextField(**NULLABLE, verbose_name='Описание', help_text='Укажите описание')
    preview_course = models.ImageField(upload_to='materials/preview_course', **NULLABLE, verbose_name='Превью', help_text='Укажите превью')
...
class Lesson(models.Model):
    title = models.CharField(max_length=100, verbose_name='Название урока', help_text='Укажите урок', null=False)
    ...
    preview_lesson = models.ImageField(upload_to='materials/preview_lesson', **NULLABLE, verbose_name='Превью',
